...
const Footer = ({ footerScroll }) => {
  ...
  return (
    <footer
      ref={footerScroll}
      className={`py-20 ${lightTheme ? "bg-[#005269]" : "bg-[black]"} text-white`}
    >
      <div className="w-[90%] max-w-[1240px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 py-4">
        ...
        <div>
          ...
          <a
            href="tel:+2347056877425"
            className="text-md flex items-center gap-1 hover:text-[#63f2a9] duration-300 my-3"
          >
          ...
          <a
            ...
            className="text-md flex items-center gap-1 hover:text-[#63f2a9] duration-300"
          >
